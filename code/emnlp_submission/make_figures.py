...
DATA = Path("/sessions/adoring-focused-lamport/mnt/outputs/"
            "final_data_package/csv")
OUT = HERE / "figures"
...
# =============================================================================
# Figure 7: mechanism evidence (column width)
#  Matched-triplet recovery vs item-mismatched controls per model.
#  Defined here so its source-file ordering produces Figure 7 in the rendered
#  PDF (logit-decomp is included first in main.tex and renders as Figure 6).
# =============================================================================
def fig7_evidence():
...
# =============================================================================
# Figure 6: logit decomposition (column width)
#  Shows target_logit_delta vs distractor_logit_delta per model with diff line.
# =============================================================================
